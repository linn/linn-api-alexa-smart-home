...
import { SpeakerEndpoint, IEndpoint } from '../src/models/IEndpoint';
...
describe('DiscoveryHandler', () => {
    ...
    test('Should call request a list of endpoints', () => {
        ...
        let endpoints : IEndpoint[] = alexaResponse.event.payload.endpoints;
        expect(endpoints).toHaveLength(1);
        expect(endpoints[0].endpointId).toBe("SPEAKER_ID");
    });
});
